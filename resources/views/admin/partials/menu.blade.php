    ...
    <ul class="sidebar-panel nav">
        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    <a href="modal-boxes.html">Modal Boxes</a>
                </li>
                <li>
                ...
                <li>
                    <a href="others.html">
                        Others<span class="label label-danger">NEW</span>
                    </a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <a href="data-table.html">Data Tables</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="#">
                    <span class="icon color10">
                ...
                <ul>
                    ...
                    <li>
                        <a href="layouts.html">Form Layouts</a>
                    </li>
                    <li>
                        <a href="text-editors.html">Text Editors</a>
                    </li>
                </ul>
            </li>
            <li>
        ...
        <div class="sidebar-plan"> Pro Plan
